...
class ChestionarScreen extends StatefulWidget {
  ...
  const ChestionarScreen({ super.key, required this.chestionar, });
  ...
  initState(){
    ...
    setState(() {
        ...
        if (widget.chestionar.listaRaspunsuri[0].informatiiComplementare.isNotEmpty)
        {
          ...
          alergicLaMedicament = (widget.chestionar.listaRaspunsuri[0].raspunsIntrebare == '1')? widget.chestionar.listaRaspunsuri[0].informatiiComplementare : '';
            ...
            children: [
              Row (
                ...
                children: [
                  ...
                  Text(
                    l.chestionarNumePrenumePacient, 
              ...
              Row (
                mainAxisAlignment:MainAxisAlignment.start,
                children: [
                  Text(numePrenumeComplet, style: GoogleFonts.rubik(color: const Color.fromRGBO(103, 114, 148, 1), fontSize: 12, fontWeight: FontWeight.w300)),
                  const SizedBox(width: 25),
                ],
              ),
            ],
          ...
          Row( 
            ...
            children: [
              ...
              Row (
                mainAxisAlignment:MainAxisAlignment.start,
                children: [
                  Text(dataDeNastere, style: GoogleFonts.rubik(color: const Color.fromRGBO(103, 114, 148, 1), fontSize: 12, fontWeight: FontWeight.w300)),
                  const SizedBox(width: 25),
                ],
              ),
            ],
          ...
          Row(
            ...
            children: [
              ...
              Row (
                mainAxisAlignment:MainAxisAlignment.start,
                children: [
                  Text(greutate, style: GoogleFonts.rubik(color: const Color.fromRGBO(103, 114, 148, 1), fontSize: 12, fontWeight: FontWeight.w300)),
                  const SizedBox(width: 25),
                ],
              ),
            ],
          ...
          Row(
            ...
            children: [
              ...
              Row (
                mainAxisAlignment:MainAxisAlignment.start,
                children: [
                  CustomCheckBox(isChecked: areFebra,),
                  const SizedBox(width: 25),
                ],
              ),
            ],
          ...
          Row(
            ...
            children: [
              ...
              Row (
                mainAxisAlignment:MainAxisAlignment.start,
                children: [
                  CustomCheckBox(isChecked: tuseste, ), //onChecked: callbackTuse //old IGV
                  const SizedBox(width: 25),
                ],
              ),
            ],
          ...
          Row(
            ...
            children: [
              ...
              Row (
                mainAxisAlignment:MainAxisAlignment.start,
                children: [
                  CustomCheckBox(isChecked: dificultatiRespiratorii, ), //onChecked: callbackRespiratie //old IGV
                  const SizedBox(width: 25),
                ],
              ),
            ],
          ...
          Row(
            ...
            children: [
              ...
              Row (
                mainAxisAlignment:MainAxisAlignment.start,
                children: [
                  CustomCheckBox(isChecked: astenie,), // onChecked: callbackAstenie //old IGV
                  const SizedBox(width: 25),
                ],
              ),
            ],
          ...
          Row(
            ...
            children: [
              ...
              Row (
                mainAxisAlignment:MainAxisAlignment.start,
                children: [
                  CustomCheckBox(isChecked: cefalee,),  //onChecked: callbackCefalee//old IGV
                  const SizedBox(width: 25),
                ],
              ),
            ],
          ...
          Row(
            ...
            children: [
              ...
              Row (
                mainAxisAlignment:MainAxisAlignment.start,
                children: [
                  CustomCheckBox(isChecked: dureriGat, ), //onChecked: callbackDureriGat //old IGV
                  const SizedBox(width: 25),
                ],
              ),
            ],
          ...
          Row(
            ...
            children: [
              ...
              Row (
                mainAxisAlignment:MainAxisAlignment.start,
                children: [
                  CustomCheckBox(isChecked: greturiVarsaturi, ), //onChecked: callbackGreturiVarsaturi //old IGV
                  const SizedBox(width: 25),
                ],
              ),
            ],
          ...
          Row(
            ...
            children: [
              ...
              Row (
                mainAxisAlignment:MainAxisAlignment.start,
                children: [
                  CustomCheckBox(isChecked: diareeConstipatie, ), //onChecked: callbackDiareeConstipatie //old IGV
                  const SizedBox(width: 25),
                ],
              ),
            ],
          ...
          Row(
            ...
            children: [
              ...
              Row (
                mainAxisAlignment:MainAxisAlignment.start,
                children: [
                  CustomCheckBox(isChecked: iritatiiPiele, ), //onChecked: callbackIritatiiPiele //old IGV
                  const SizedBox(width: 25),
                ],
              ),
            ],
          ...
          Row(
            ...
            children: [
              ...
              Row (
                mainAxisAlignment:MainAxisAlignment.start,
                children: [
                  CustomCheckBox(isChecked: nasInfundat, ), //onChecked: callbackNasInfundat //old IGV
                  const SizedBox(width: 25),
                ],
              ),
            ],
          ...
          Row(
            ...
            children: [
              ...
              Row (
                mainAxisAlignment:MainAxisAlignment.start,
                children: [
                  CustomCheckBox(isChecked: rinoree, ), //onChecked: callbackRinoree //old IGV
                  const SizedBox(width: 25),
                ],
              ),
            ],
