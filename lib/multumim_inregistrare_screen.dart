          ...
          child: Stack(
            children: [
              Image.asset(
                height: 640,
                width: 440,
                './assets/images/multumim_background.png'
              ),
              Column(
                children: [
                    ...
                    Column(
                      ...
                      children: [
                        Image.asset(
                          width: 67,
                          height:65,
                          './assets/images/ok_multumim_icon.png'
                        ),
                            ...
                            child:
                              Center(
                                child:Text(
                                  ...
                                  style: GoogleFonts.rubik(
                                    color: const Color.fromRGBO(103, 114, 148, 1), fontWeight: FontWeight.w300, fontSize: 13),
                                    //color: Colors.white, fontWeight: FontWeight.w500, fontSize: 24), old cu mesajul RIGHT OVERFLOW BY 3 PIXELS
                                  maxLines: 2,
                              ...
                              TextSpan(
                                ...
                                children: <TextSpan>[
                                  ...
                                  TextSpan(
                                    ...
                                    style: GoogleFonts.rubik( color: const Color.fromRGBO(14, 190, 127, 1),
