...
class _ChatScreenState extends State<ChatScreen> {
  ...
  DateTime? _sessionCompletionTime;
  final ValueNotifier<String> _timerText = ValueNotifier<String>('');
  ...
  void initState() {
    ...
    _listenForConversationCompletion();
  }
  ...
  void _listenForConversationCompletion() {
    _firestore
      ...
      if (snapshot.exists && mounted) {
        ...
        setState(() {
          _showExitButton = isCompleted && widget.isDoctor;
        });
      }
    });
  }
    ...
    _firestore
      ...
      if (snapshot.docs.isNotEmpty && mounted) {
        await _sendFeedbackMessage(
          message: 'The patient has left the chat.',
          visibility: 'doctor',
        );
        setState(() {
  ...
  void _startVisibleTimer(DateTime completionTime) {
    ...
    _sessionCompletionTime = completionTime;
                ...
                StreamBuilder<DocumentSnapshot>(
                  ...
                  builder: (context, snapshot) {
                    ...
                    return TextButton.icon(
                      ...
                      icon: const Icon(Icons.check_circle_outline, size: 18, color: Color(0xFFFFFFFF)),
                      label: Text(
                        'AM RĂSPUNS',
                        style: GoogleFonts.rubik(
                          fontSize: 13,
              ...
              children: [
                Expanded(
                  child: TextField(
                    ...
                    onSubmitted: (_) => _sendMessage(visibility: 'both'),
                  ),
                ),
                SizedBox(width: 8.0),
                Container(
                ...
                Container(
                  ...
                  child: IconButton(
                    ...
                    onPressed: () => _sendMessage(visibility: 'both'),
                  ),
                ),
              ],
            ),
...
//         'senderName': currentUserName,
//         'type': 'text',
//         'message': 'Medicul a încheiat sesiunea 🩺. Poți ieși din chat sau poți adresa încă o întrebare medicului.',
//         'messageStatus': 'completed',
//         'completionTimestamp': 0,
//       });
//
