...
import './util.dart';
import './models/bubble_rtl_alignment.dart' as bubble;


class TypingIndicatorIGV extends StatefulWidget {
  const TypingIndicatorIGV({
    super.key,
  ...
  final bubble.BubbleRtlAlignment bubbleAlignment;
  ...
  @override
  State<TypingIndicatorIGV> createState() => _TypingIndicatorStateIGV();
}

class _TypingIndicatorStateIGV extends State<TypingIndicatorIGV>
  ...
  @override
  void didUpdateWidget(TypingIndicatorIGV oldWidget) {
...
class TypingWidget extends StatelessWidget {
  ...
  final TypingIndicatorIGV widget;
  ...
  String _multiUserTextBuilder(List<types.User> author) {
    if (author.isEmpty) {
      ...
      return '${author.first.firstName} scrie ...';
    } else if (author.length == 2) {
      return '${author.first.firstName} și ${author[1].firstName}';
    } else {
      return '${author.first.firstName} și ${author.length - 1} alții';
    }
  }
...
extension TypingIndicatorIGVExtension on TypingIndicatorIGV {
  //TypingIndicatorIGV get toTypingIndicatorIGV => TypingIndicator();
}