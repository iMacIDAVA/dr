...
class RaspundeIntrebareScreen extends StatefulWidget {

  final String textNume;
  final String textIntrebare;
  final String textRaspuns;

  const RaspundeIntrebareScreen({
  ...
  @override
  State<RaspundeIntrebareScreen> createState() => _RaspundeIntrebareScreenState();

}

class _RaspundeIntrebareScreenState extends State<RaspundeIntrebareScreen> {
